                            ...
                            <div class="row">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type" required onchange="toggleBox()">
                                        <option value="<?php echo $user['cl_type']; ?>">
                                            <?php echo $user['cl_type']; ?>
                                        </option>
                                        <option value="Client">Client</option>
                                        <option value="Supplier">Supplier</option>
                                    </select>
                                </div>
                                <div class="col-6 mb-3" id="supplierBox" <?php if ($user['cl_type'] === "Supplier")
                                ...
                                <div class="col-6 mb-3" id="clientBox" <?php if ($user['cl_type'] === "Client")
                                    echo "style='display:none;'"; ?>>
